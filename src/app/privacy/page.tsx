    ...
    <article className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground [&_a]:underline [&_h2]:mt-8 [&_h2]:text-base [&_h2]:font-semibold [&_h2]:text-foreground">
        ...
        <section>
          ...
          <p>To provide the Service (generate tattoo previews), process payments, maintain your generation history, prevent abuse and prohibited content, and improve the Service.</p>
        </section>

        <section>
          <h2>3. AI Processing</h2>
          <p>To generate previews, your uploaded photo and prompt are sent to our AI provider (Kie.ai, routing to OpenAI image models), which produces the preview images. Do not upload photos or describe ideas you do not have rights to or that contain sensitive personal information.</p>
        </section>

        <section>
          <h2>4. Third-Party Services</h2>
          <ul className="ml-5 list-disc space-y-1">
            <li><strong className="text-foreground">Clerk</strong> — user authentication.</li>
        ...
        <section>
          ...
          <p>Your photos, prompts, and generated images are stored so you can view your history. They are kept while your account is active and deleted when you request account deletion.</p>
        </section>

        <section>
          <h2>6. Cookies</h2>
          <p>We use only essential authentication cookies (via Clerk) to keep you signed in. We do not use advertising or tracking cookies.</p>
        </section>

        <section>
          <h2>7. Your Rights</h2>
          <p>You may request access to, export of, or deletion of your data at any time. {supportEmail ? <>Contact us at <a href={`mailto:${supportEmail}`}>{supportEmail}</a>.</> : 'Contact our support team.'}</p>
        </section>

        <section>
          <h2>8. Children</h2>
          <p>The Service is not intended for anyone under 13. Do not use the Service if you are under 13.</p>
        </section>
